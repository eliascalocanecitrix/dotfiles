...
;; ## added by OPAM user-setup for emacs / tuareg ## 086295694ce96425e1fd9cf4b531e5d7 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/root/.opam/4.06.1/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
